...
public class PostServlet extends MethodDispatcherServlet {
    ...
    public  void updateConfire(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    public void addPostConfire(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
