...
$(function(){
	$("#btn-return").click(function(){
		document.location.href='doFindObjects.do'
	})
})
</script>
</head>
...
<div class="container">
 ...
 <h1>${message}</h1>
 <form action="doSaveObject.do" method="post" class="form-horizontal" role="form">
	<div class="form-group">
		<label for="nameId" class="col-sm-2 control-label" >名字:</label> 
	    <div class="col-sm-10">
