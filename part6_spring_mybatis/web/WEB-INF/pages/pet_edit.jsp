...
<div class="container">
 ...
 <form action="doSave.do" method="post" class="form-horizontal" role="form">
	...
	<%--</div>--%>
	<div class="form-group">
		<label for="project-code" class="col-sm-2 control-label">宠物id:</label>
		<div class="col-sm-10">
		<input type="text" class="form-control required" name="id" id="codeId" value="${pet.id}">
		</div>
	</div>
	<div class="form-group">
		<label for="project-code"  class="col-sm-2 control-label">宠物代码:</label>
		<div class="col-sm-10">
		<input type="text" class="form-control datepicker " name="code" id="beginDateId" value="${pet.code}">
		</div>
	</div>
	<div class="form-group">
		<label for="project-code" class="col-sm-2 control-label">宠物名字:</label>
		<div class="col-sm-10">
		<input type="text" class="form-control datepicker "  name="name" id="endDateId" value="${pet.name}">
		</div>
	</div>
	<div class="form-group">
		<div class="form-group">
			<label for="project-code" class="col-sm-2 control-label">备注:</label>
			<div class="col-sm-10">
				<input type="text" class="form-control datepicker "  name="note"   value="${pet.note}">
			</div>
		</div>
	<div class="form-group">
